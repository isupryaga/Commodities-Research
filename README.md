...
Using historical COT positioning data across multiple agriculture markets, signals were developed using extreme commercial positioning percentiels within normalized COT distributions, and were then evaluated on their predictive and portfolio performance through backtesting. The project explores:
